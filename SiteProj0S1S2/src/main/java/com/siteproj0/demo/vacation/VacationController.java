...
public class VacationController {
	...
	public ResponseEntity approveVacationRequest(@RequestHeader("token") UUID securityToken,
		...
		try {
			...
			DoctorDbModel doctor = vdbm.getDoctor();
			try {
				...
				try {
					...
					message.setText("Your vacation request has been approved!");
		...
		try {
			...
			try {
				...
				try {
					...
					// Now set the actual message
					message.setText("Your vacation request has been rejected. Reason: " + notes);
